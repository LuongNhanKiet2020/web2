...
<div class="wrap">	
	<div class="main">
		<h2 class="style top">Men Pants</h2>
		<div class="row justify-content-end" style="width: 93%">
			<div>
				<div class="row">
					<div class="col">
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Tìm kiếm..." id="name_menpants">
						</div>
					</div>
					<div class="col">
					...
					<div class="col">
						<button class="btn btn-success" onClick="FindProduct($('#name_menpants').val(), 'menpants', $('.giabd').val(), $('.giact').val())">Tìm kiếm</button>
					</div>
				</div>
			</div>
		</div>
				...
				<?php
					if($dieukien == ''){
						if($giabd != 100 || $giact != 1000){
							$soSanPham = product_MenPants($currentPage, $dieukien, $giabd, $giact);
						...
						echo'<table class="text-center" style="width: 100%;">
							<tr>
								<td style="padding: 10%">
									...
									<a href="./index.php?action=menpants&timkiem=&giabd=100&giact=1000">Quay lại trang menpants</a>
								</td>
							</tr>
						</table>';
					}
