...
<div class="wrap">	
	<div class="main">
		<h2 class="style top">Men Shirts</h2>
		<div class="row justify-content-end" style="width: 93%">
			<div>
				<div class="row">
					<div class="col">
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Tìm kiếm..." id="name_menshirt">
						</div>
					</div>
					<div class="col">
					...
					<div class="col">
						<button class="btn btn-success" onClick="FindProduct($('#name_menshirt').val(), 'menshirt', $('.giabd').val(), $('.giact').val())">Tìm kiếm</button>
					</div>
				</div>
			</div>
		</div>
				...
				<?php
					if($dieukien == ''){
						if($giabd != 100 || $giact != 1000){
							$soSanPham = product_MenShirts($currentPage, $dieukien, $giabd, $giact);
